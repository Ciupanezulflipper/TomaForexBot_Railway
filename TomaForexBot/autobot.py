...
from marketdata import connect, disconnect, get_ohlc
...
def analyze_and_alert(symbol, tf=mt5.TIMEFRAME_H1, bars=50, pattern_threshold=2):
    print(f"🔍 Analyzing {symbol}...")

    df = get_ohlc(symbol, tf, bars=bars)
    if df.empty:
