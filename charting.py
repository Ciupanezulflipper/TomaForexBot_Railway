...
async def generate_pro_chart_async(df, symbol, timeframe, score=None, signal_type=None, reasons=None):
    return await asyncio.to_thread(generate_pro_chart, df, symbol, timeframe, score, signal_type, reasons)